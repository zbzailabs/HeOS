...
INSERT OR IGNORE INTO heos_standard_dictionary (
  ...
  ('std-dict-unit-volt-v0-1', 'unit', 'volt', '伏特', '电压单位，符号 V。', NULL, 'v0.1', 'heos-prd', 'docs/heos-prd/06-标准对齐任务清单-v0.1.md#S0-01', '2026-06-10T00:00:00.000Z', NULL, 'active', 70),
  ('std-dict-unit-dbm-v0-1', 'unit', 'dbm', '毫瓦分贝', '信号强度单位 dBm。', NULL, 'v0.1', 'heos-prd', 'docs/heos-prd/06-标准对齐任务清单-v0.1.md#S0-01', '2026-06-10T00:00:00.000Z', NULL, 'active', 80),
  ...
  ('std-dict-metric-co2-v0-1', 'metric', 'co2', '二氧化碳浓度', '空气二氧化碳浓度遥测指标。', 'ppm', 'v0.1', 'heos-prd', 'docs/heos-prd/06-标准对齐任务清单-v0.1.md#S0-01', '2026-06-10T00:00:00.000Z', NULL, 'active', 60),
  ('std-dict-metric-soil-ec-v0-1', 'metric', 'soil_ec', '土壤电导率', '土壤电导率遥测指标。', 'us_cm', 'v0.1', 'heos-prd', 'docs/heos-prd/06-标准对齐任务清单-v0.1.md#S0-01', '2026-06-10T00:00:00.000Z', NULL, 'active', 70),
  ('std-dict-metric-soil-ph-v0-1', 'metric', 'soil_ph', '土壤酸碱度', '土壤 pH 遥测指标。', 'ph', 'v0.1', 'heos-prd', 'docs/heos-prd/06-标准对齐任务清单-v0.1.md#S0-01', '2026-06-10T00:00:00.000Z', NULL, 'active', 80),
  ('std-dict-metric-battery-voltage-v0-1', 'metric', 'battery_voltage', '电池电压', '设备电池电压遥测指标。', 'volt', 'v0.1', 'heos-prd', 'docs/heos-prd/06-标准对齐任务清单-v0.1.md#S0-01', '2026-06-10T00:00:00.000Z', NULL, 'active', 90),
  ('std-dict-metric-signal-strength-v0-1', 'metric', 'signal_strength', '信号强度', '设备通信信号强度遥测指标。', 'dbm', 'v0.1', 'heos-prd', 'docs/heos-prd/06-标准对齐任务清单-v0.1.md#S0-01', '2026-06-10T00:00:00.000Z', NULL, 'active', 100),
